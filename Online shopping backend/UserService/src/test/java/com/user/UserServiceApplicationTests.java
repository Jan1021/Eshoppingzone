...
//		when(profileRepo.findAll()).thenReturn(Stream.of(new UserEntity(1, "Pranav", "pranjal@gmail.com", 734646648L, "this is s", "female", "admin", "root")).collect(Collectors.toList()));
//		assertEquals(1, userService.getUsers().size());
//	}

	@Test
	public void addUserTest() {
		UserEntity user = new UserEntity(1, "Pranav", "pranav@gmail.com",23344L,"df", 2, "male","user","wee");
